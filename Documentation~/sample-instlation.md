...
The following sample scenes can be found by opening the sample project and opening the `Assets\Samples\Unity Toon Shader\0.5.0-preview\Universal render pipeline` folder.  
...
* for Legacy (Built-in)：`Assets\Samples\Unity Toon Shader\0.5.0-preview\Legacy render pipeline` folder  
* for HDRP：`Assets\Samples\Unity Toon Shader\0.5.0-preview\High definition render pipeline` folder 